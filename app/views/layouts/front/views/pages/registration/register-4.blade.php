...
<div id="profile" class="row">
  <div class="col-lg-12 text-center">
    <img class="img-responsive" src="images/sample-profile.jpg" alt="" />
    <p>Make sure to upload a similar photo from above as your Main Profile Photo</p>
  </div>
</div>
...
<!-- <div class="row">
  ...
  <div class="col-lg-6">
    <div class="form-group inputDnD">
      <label for="inputFile"><span class="red">*</span>Portfolio Video/s</label>
      <input type="file" class="form-control-file text-primary font-weight-bold" id="inputFile" accept="image/*" onchange="readUrl(this)" data-title="Drag and drop a file">
    </div>
  </div>
</div> -->
