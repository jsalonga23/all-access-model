...
<head>
    ...
    <!-- MetisMenu CSS -->
    {{ HTML::style('admin/bootstrap/bower_components/bootstrap/dist/metisMenu.min.css', array('rel' => 'stylesheet'))); }}

    <!-- Custom CSS -->
    {{ HTML::style('admin/bootstrap/bower_components/bootstrap/dist/css/sb-admin-2.css', array('rel' => 'stylesheet')); }}
